...
function createGUI (withStats) {
  ...
  var axisLights = gui.addFolder ('Axis and Lights');
    ...
    axisLights.add(GUIcontrols, 'light1').name('Light1 on/off :');
    axisLights.add(GUIcontrols, 'lightIntensity', 0, 1.0).name('Light intensity :');
    axisLights.add(GUIcontrols, 'light2').name('Light2 on/off :');
    axisLights.add(GUIcontrols, 'lightIntensity2', 0, 1.0).name('Light 2 intensity :');
  ...
  var craneControls = gui.addFolder ('Crane Controls');
    craneControls.add(GUIcontrols, 'transform').name('Transforms on/off :');
