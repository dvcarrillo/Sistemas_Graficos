...
class Crane extends THREE.Object3D {
  ...
  createBase() {
    var base = new THREE.Mesh(
      ...
      //this.material);
      new THREE.BoxGeometry(this.craneWidth / 5 , this.craneWidth / 100, this.craneWidth / 5),
      this.material);
  ...
  createTrolleyStringHook() {
    ...
    this.string = new THREE.Mesh(
      new THREE.CylinderGeometry(this.craneWidth / 500, this.craneWidth / 500, 1), this.material);
